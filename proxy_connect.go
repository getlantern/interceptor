...
func CONNECT(
	...
	// bufferSource specifieds a BufferSource, leave nil to use default
...
func (ic *interceptor) connect(op ops.Op, w http.ResponseWriter, req *http.Request) {
...
func (ic *interceptor) hostIncludingPort(req *http.Request) string {
